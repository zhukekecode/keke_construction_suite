odoo.define('keke_construction.ImportEstimate', function (require) {
    "use static";
    ...
    var ImportEstimate = Widget.extend({
        template: 'ImportEstimate',
        events: {
    ...
    widgetRegistry.add('import_estimate', ImportEstimate);
});
