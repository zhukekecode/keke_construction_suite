odoo.define('kcms.purchase.dashboard', function (require) {
    "use strict";
    ...
    var PurchaseListDashboardRenderer = ListRenderer.extend({
        ...
        _renderView: function () {
            ...
            return this._super.apply(this, arguments).then(function () {
                ...
                var purchase_dashboard = QWeb.render('kcms.purchase.PurchaseDashboard', {
                    values: values,
                });
    ...
    var PurchaseListDashboardModel = ListModel.extend({
        ...
        __get: function (localID) {
            ...
            if (_.isObject(result)) {
                result.dashboardValues = this.dashboardValues;
            }
            return result;
        },
        ...
        _load: function (dataPoint, options) {
            ...
            if (dataPoint.type === 'list' && !dataPoint.groupedBy.length) {
                return this._loadDashboard(this._fetchUngroupedList(dataPoint, options), dataPoint['domain']);
        ...
        _loadDashboard: function (super_def , domain) {
            ...
            return Promise.all([super_def, dashboard_def]).then(function (results) {
                ...
                self.dashboardValues = dashboardValues;
                return id;
            });
        },
    });
...
//--------------------------------------------------------------------------
    ...
    view_registry.add('kcms_purchase_list_dashboard', PurchaseListDashboardView);
